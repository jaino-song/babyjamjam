  ...
  return createPortal(
    ...
    >
      {showCart && isCartOpen && (
        <aside
          id={cartPanelId}
          className="floating-cart-panel floating-cart-panel-mobile"
          role="dialog"
          aria-modal={false}
          ...
          >
            ...
            {selectedPlan && (
              ...
              >
                ...
                <button
                  type="button"
                  className="floating-cart-panel__item-remove floating-cart-panel__item-remove-mobile"
