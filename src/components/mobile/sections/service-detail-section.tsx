...
export function MobileServiceDetailSection({ className }: ServiceDetailSectionProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <KakaoChatPhone data-component="mobile-home-service-detail-kakao-chat-phone" />
        </div>
      </div>
    </section>
  );
