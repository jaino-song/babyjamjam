...
import { MobilePricingFormModal } from "@/components/mobile/sections/pricing-form-modal";
import { MobilePricingPlansSection } from "@/components/mobile/sections/pricing-plans-section";
...
export function MobilePricingClient({
  "data-component": dataComponent,
}: MobilePricingClientProps) {
  ...
  return (
    <>
      ...
      {showFormModal &&
        ...
        createPortal(
          <div
            className="pricing-form-overlay pricing-form-overlay-mobile"
