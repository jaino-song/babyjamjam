  ...
  return (
    <>
      <main
        ...
        data-component="desktop_home_page-main"
      >
        <section
          className="flex w-full flex-col items-center gap-16"
          data-component="desktop_home_hero_section"
        >
          <DesktopHeroCarousel data-component="desktop_home_hero-carousel" />
          <h1
            className="h1 block w-full whitespace-pre-line text-bjj-primary"
            data-component="desktop_home_hero_headline"
          >
            엄마의 설레는 첫 만남.
            <br data-component="desktop_home_hero_headline_break" />
            아기의 완벽한 첫 걸음.
          </h1>
        </section>
        ...
        <LogoCarousel data-component="desktop_home_logo-carousel" />

        <section
          className="flex min-h-[588px] w-full items-center justify-between gap-12"
          data-component="desktop_home_app_detail_section"
        >
          <div
            className="flex flex-[7_1_0] flex-col items-start gap-6 pb-[52px]"
            data-component="desktop_home_app_detail_content"
          >
            <div
              className="flex w-full flex-col items-start gap-6"
              data-component="desktop_home_app_detail_copy"
            >
              <h2
                className="h2-left text-bjj-primary"
                data-component="desktop_home_app_detail_heading"
              >
                아가잼잼 공식 앱은
                <br data-component="desktop_home_app_detail_heading_break" />
                상담부터 환급 신청까지 일사천리.
              </h2>
              <div
            ...
            <div
              ...
              data-component="desktop_home_app_detail_steps"
            >
            ...
            <div
              ...
              data-component="desktop_home_app_detail_launch"
            >
              <button
                type="button"
                ...
                disabled
                data-component="desktop_home_app_detail_launch_button"
              >
                출시 예정
              </button>
              <p
                className="text-xs text-gray-400"
                data-component="desktop_home_app_detail_launch_note"
              >
                *출시 전까지는 유선으로 서비스 제공
              </p>
            </div>
          ...
          <div
            ...
            data-component="desktop_home_app_detail_preview"
          >
            <div
              className="relative aspect-[1350/2760] w-full max-w-[312px] drop-shadow-[0_28px_56px_rgba(2,22,56,0.18)]"
              data-component="desktop_home_app_detail_preview_frame"
            >
              <div
                ...
                data-component="desktop_home_app_detail_preview_screen"
              >
                <iframe
                  ...
                  scrolling="no"
                  data-component="desktop_home_app_detail_preview_iframe"
                />
              </div>
              <img
                ...
                alt="아가잼잼 앱 목업"
                data-component="desktop_home_app_detail_preview_image"
              />
            </div>
          </div>
        </section>

        <ProcessSection data-component="desktop_home_process-section" />
        <MoreSection data-component="desktop_home_more-section" />
      </main>

      <Footer data-component="desktop_home_footer-section" />
    </>
  );
}
