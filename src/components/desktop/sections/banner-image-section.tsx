...
export function DesktopBannerImageSection({ className }: BannerImageSectionProps) {
  ...
  return (
    <div
      ref={wrapperRef}
      className={cn("relative w-screen h-[752px] overflow-hidden will-change-[clip-path] flex items-center justify-center", className)}
    ...
    >
      ...
      />
      <span
        className="h3 relative! z-[1] text-bjj-bg [text-shadow:1px_4px_8px_rgba(0,0,0,0.25)] text-center whitespace-nowrap w-auto"
